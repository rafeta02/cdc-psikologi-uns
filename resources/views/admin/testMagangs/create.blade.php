...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.test-magangs.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('q_1') ? 'is-invalid' : '' }}" type="number" name="q_1" id="q_1" value="{{ old('q_1', '') }}" step="1">
                @if($errors->has('q_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('q_2') ? 'is-invalid' : '' }}" type="text" name="q_2" id="q_2" value="{{ old('q_2', '') }}">
                @if($errors->has('q_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('q_3') ? 'is-invalid' : '' }}" type="number" name="q_3" id="q_3" value="{{ old('q_3', '') }}" step="1">
                @if($errors->has('q_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('q_4') ? 'is-invalid' : '' }}" type="number" name="q_4" id="q_4" value="{{ old('q_4', '') }}" step="1">
                @if($errors->has('q_4'))
