...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.mahasiswa-magangs.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instansi') ? 'is-invalid' : '' }}" type="text" name="instansi" id="instansi" value="{{ old('instansi', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('alamat_instansi') ? 'is-invalid' : '' }}" name="alamat_instansi" id="alamat_instansi">{{ old('alamat_instansi') }}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('pretest') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="pretest" id="pretest" value="1" {{ old('pretest', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('posttest') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="posttest" id="posttest" value="1" {{ old('posttest', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dosen_pembimbing') ? 'is-invalid' : '' }}" type="text" name="dosen_pembimbing" id="dosen_pembimbing" value="{{ old('dosen_pembimbing', '') }}">
