...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.work-readiness-tests.update", [$workReadinessTest->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cbs_1') ? 'is-invalid' : '' }}" type="number" name="cbs_1" id="cbs_1" value="{{ old('cbs_1', $workReadinessTest->cbs_1) }}" step="1">
                @if($errors->has('cbs_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cbs_2') ? 'is-invalid' : '' }}" type="number" name="cbs_2" id="cbs_2" value="{{ old('cbs_2', $workReadinessTest->cbs_2) }}" step="1">
                @if($errors->has('cbs_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cbs_3') ? 'is-invalid' : '' }}" type="number" name="cbs_3" id="cbs_3" value="{{ old('cbs_3', $workReadinessTest->cbs_3) }}" step="1">
                @if($errors->has('cbs_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cbs_4') ? 'is-invalid' : '' }}" type="number" name="cbs_4" id="cbs_4" value="{{ old('cbs_4', $workReadinessTest->cbs_4) }}" step="1">
                @if($errors->has('cbs_4'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cbs_5') ? 'is-invalid' : '' }}" type="number" name="cbs_5" id="cbs_5" value="{{ old('cbs_5', $workReadinessTest->cbs_5) }}" step="1">
                @if($errors->has('cbs_5'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cbs_6') ? 'is-invalid' : '' }}" type="number" name="cbs_6" id="cbs_6" value="{{ old('cbs_6', $workReadinessTest->cbs_6) }}" step="1">
                @if($errors->has('cbs_6'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cbs_7') ? 'is-invalid' : '' }}" type="number" name="cbs_7" id="cbs_7" value="{{ old('cbs_7', $workReadinessTest->cbs_7) }}" step="1">
                @if($errors->has('cbs_7'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cbs_8') ? 'is-invalid' : '' }}" type="number" name="cbs_8" id="cbs_8" value="{{ old('cbs_8', $workReadinessTest->cbs_8) }}" step="1">
                @if($errors->has('cbs_8'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cbs_9') ? 'is-invalid' : '' }}" type="number" name="cbs_9" id="cbs_9" value="{{ old('cbs_9', $workReadinessTest->cbs_9) }}" step="1">
                @if($errors->has('cbs_9'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cbs_10') ? 'is-invalid' : '' }}" type="number" name="cbs_10" id="cbs_10" value="{{ old('cbs_10', $workReadinessTest->cbs_10) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cms_1') ? 'is-invalid' : '' }}" type="number" name="cms_1" id="cms_1" value="{{ old('cms_1', $workReadinessTest->cms_1) }}" step="1">
                @if($errors->has('cms_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cms_2') ? 'is-invalid' : '' }}" type="number" name="cms_2" id="cms_2" value="{{ old('cms_2', $workReadinessTest->cms_2) }}" step="1">
                @if($errors->has('cms_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cms_3') ? 'is-invalid' : '' }}" type="number" name="cms_3" id="cms_3" value="{{ old('cms_3', $workReadinessTest->cms_3) }}" step="1">
                @if($errors->has('cms_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cms_4') ? 'is-invalid' : '' }}" type="number" name="cms_4" id="cms_4" value="{{ old('cms_4', $workReadinessTest->cms_4) }}" step="1">
                @if($errors->has('cms_4'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cs_1') ? 'is-invalid' : '' }}" type="number" name="cs_1" id="cs_1" value="{{ old('cs_1', $workReadinessTest->cs_1) }}" step="1">
                @if($errors->has('cs_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cs_2') ? 'is-invalid' : '' }}" type="number" name="cs_2" id="cs_2" value="{{ old('cs_2', $workReadinessTest->cs_2) }}" step="1">
                @if($errors->has('cs_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cs_3') ? 'is-invalid' : '' }}" type="number" name="cs_3" id="cs_3" value="{{ old('cs_3', $workReadinessTest->cs_3) }}" step="1">
                @if($errors->has('cs_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cs_4') ? 'is-invalid' : '' }}" type="number" name="cs_4" id="cs_4" value="{{ old('cs_4', $workReadinessTest->cs_4) }}" step="1">
                @if($errors->has('cs_4'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cs_5') ? 'is-invalid' : '' }}" type="number" name="cs_5" id="cs_5" value="{{ old('cs_5', $workReadinessTest->cs_5) }}" step="1">
                @if($errors->has('cs_5'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cs_6') ? 'is-invalid' : '' }}" type="number" name="cs_6" id="cs_6" value="{{ old('cs_6', $workReadinessTest->cs_6) }}" step="1">
                @if($errors->has('cs_6'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cs_7') ? 'is-invalid' : '' }}" type="number" name="cs_7" id="cs_7" value="{{ old('cs_7', $workReadinessTest->cs_7) }}" step="1">
                @if($errors->has('cs_7'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cs_8') ? 'is-invalid' : '' }}" type="number" name="cs_8" id="cs_8" value="{{ old('cs_8', $workReadinessTest->cs_8) }}" step="1">
                @if($errors->has('cs_8'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cs_9') ? 'is-invalid' : '' }}" type="number" name="cs_9" id="cs_9" value="{{ old('cs_9', $workReadinessTest->cs_9) }}" step="1">
                @if($errors->has('cs_9'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fs_1') ? 'is-invalid' : '' }}" type="number" name="fs_1" id="fs_1" value="{{ old('fs_1', $workReadinessTest->fs_1) }}" step="1">
                @if($errors->has('fs_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fs_2') ? 'is-invalid' : '' }}" type="number" name="fs_2" id="fs_2" value="{{ old('fs_2', $workReadinessTest->fs_2) }}" step="1">
                @if($errors->has('fs_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fs_3') ? 'is-invalid' : '' }}" type="number" name="fs_3" id="fs_3" value="{{ old('fs_3', $workReadinessTest->fs_3) }}" step="1">
                @if($errors->has('fs_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ics_1') ? 'is-invalid' : '' }}" type="number" name="ics_1" id="ics_1" value="{{ old('ics_1', $workReadinessTest->ics_1) }}" step="1">
                @if($errors->has('ics_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ics_2') ? 'is-invalid' : '' }}" type="number" name="ics_2" id="ics_2" value="{{ old('ics_2', $workReadinessTest->ics_2) }}" step="1">
                @if($errors->has('ics_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ics_3') ? 'is-invalid' : '' }}" type="number" name="ics_3" id="ics_3" value="{{ old('ics_3', $workReadinessTest->ics_3) }}" step="1">
                @if($errors->has('ics_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ics_4') ? 'is-invalid' : '' }}" type="number" name="ics_4" id="ics_4" value="{{ old('ics_4', $workReadinessTest->ics_4) }}" step="1">
                @if($errors->has('ics_4'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ics_5') ? 'is-invalid' : '' }}" type="number" name="ics_5" id="ics_5" value="{{ old('ics_5', $workReadinessTest->ics_5) }}" step="1">
                @if($errors->has('ics_5'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('its_1') ? 'is-invalid' : '' }}" type="number" name="its_1" id="its_1" value="{{ old('its_1', $workReadinessTest->its_1) }}" step="1">
                @if($errors->has('its_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('its_2') ? 'is-invalid' : '' }}" type="number" name="its_2" id="its_2" value="{{ old('its_2', $workReadinessTest->its_2) }}" step="1">
                @if($errors->has('its_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('its_3') ? 'is-invalid' : '' }}" type="number" name="its_3" id="its_3" value="{{ old('its_3', $workReadinessTest->its_3) }}" step="1">
                @if($errors->has('its_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ls_1') ? 'is-invalid' : '' }}" type="number" name="ls_1" id="ls_1" value="{{ old('ls_1', $workReadinessTest->ls_1) }}" step="1">
                @if($errors->has('ls_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ls_2') ? 'is-invalid' : '' }}" type="number" name="ls_2" id="ls_2" value="{{ old('ls_2', $workReadinessTest->ls_2) }}" step="1">
                @if($errors->has('ls_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ls_3') ? 'is-invalid' : '' }}" type="number" name="ls_3" id="ls_3" value="{{ old('ls_3', $workReadinessTest->ls_3) }}" step="1">
                @if($errors->has('ls_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ls_4') ? 'is-invalid' : '' }}" type="number" name="ls_4" id="ls_4" value="{{ old('ls_4', $workReadinessTest->ls_4) }}" step="1">
                @if($errors->has('ls_4'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ls_5') ? 'is-invalid' : '' }}" type="number" name="ls_5" id="ls_5" value="{{ old('ls_5', $workReadinessTest->ls_5) }}" step="1">
                @if($errors->has('ls_5'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sms_1') ? 'is-invalid' : '' }}" type="number" name="sms_1" id="sms_1" value="{{ old('sms_1', $workReadinessTest->sms_1) }}" step="1">
                @if($errors->has('sms_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sms_3') ? 'is-invalid' : '' }}" type="number" name="sms_3" id="sms_3" value="{{ old('sms_3', $workReadinessTest->sms_3) }}" step="1">
                @if($errors->has('sms_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sms_4') ? 'is-invalid' : '' }}" type="number" name="sms_4" id="sms_4" value="{{ old('sms_4', $workReadinessTest->sms_4) }}" step="1">
                @if($errors->has('sms_4'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sms_5') ? 'is-invalid' : '' }}" type="number" name="sms_5" id="sms_5" value="{{ old('sms_5', $workReadinessTest->sms_5) }}" step="1">
                @if($errors->has('sms_5'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sms_7') ? 'is-invalid' : '' }}" type="number" name="sms_7" id="sms_7" value="{{ old('sms_7', $workReadinessTest->sms_7) }}" step="1">
                @if($errors->has('sms_7'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sms_9') ? 'is-invalid' : '' }}" type="number" name="sms_9" id="sms_9" value="{{ old('sms_9', $workReadinessTest->sms_9) }}" step="1">
                @if($errors->has('sms_9'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sts_1') ? 'is-invalid' : '' }}" type="number" name="sts_1" id="sts_1" value="{{ old('sts_1', $workReadinessTest->sts_1) }}" step="1">
                @if($errors->has('sts_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sts_2') ? 'is-invalid' : '' }}" type="number" name="sts_2" id="sts_2" value="{{ old('sts_2', $workReadinessTest->sts_2) }}" step="1">
                @if($errors->has('sts_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sts_3') ? 'is-invalid' : '' }}" type="number" name="sts_3" id="sts_3" value="{{ old('sts_3', $workReadinessTest->sts_3) }}" step="1">
                @if($errors->has('sts_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sts_4') ? 'is-invalid' : '' }}" type="number" name="sts_4" id="sts_4" value="{{ old('sts_4', $workReadinessTest->sts_4) }}" step="1">
                @if($errors->has('sts_4'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tps_2') ? 'is-invalid' : '' }}" type="number" name="tps_2" id="tps_2" value="{{ old('tps_2', $workReadinessTest->tps_2) }}" step="1">
                @if($errors->has('tps_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tps_4') ? 'is-invalid' : '' }}" type="number" name="tps_4" id="tps_4" value="{{ old('tps_4', $workReadinessTest->tps_4) }}" step="1">
                @if($errors->has('tps_4'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tps_5') ? 'is-invalid' : '' }}" type="number" name="tps_5" id="tps_5" value="{{ old('tps_5', $workReadinessTest->tps_5) }}" step="1">
                @if($errors->has('tps_5'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tps_6') ? 'is-invalid' : '' }}" type="number" name="tps_6" id="tps_6" value="{{ old('tps_6', $workReadinessTest->tps_6) }}" step="1">
                @if($errors->has('tps_6'))
