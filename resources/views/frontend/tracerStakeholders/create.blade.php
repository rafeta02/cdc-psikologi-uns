    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.tracer-stakeholders.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nama_alumni" id="nama_alumni" value="{{ old('nama_alumni', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="tahun_lulus" id="tahun_lulus" value="{{ old('tahun_lulus', '') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="waktu_tunggu" id="waktu_tunggu" value="{{ old('waktu_tunggu', '') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\TracerStakeholder::TINGKAT_INSTANSI_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="tingkat_instansi_{{ $key }}" name="tingkat_instansi" value="{{ $key }}" {{ old('tingkat_instansi', '') === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\TracerStakeholder::KESESUAIAN_BIDANG_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="kesesuaian_bidang_{{ $key }}" name="kesesuaian_bidang" value="{{ $key }}" {{ old('kesesuaian_bidang', '') === (string) $key ? 'checked' : '' }}>
                                    <label for="kesesuaian_bidang_{{ $key }}">{{ $label }}</label>
                                </div>
                            @endforeach
                            @if($errors->has('kesesuaian_bidang'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('kesesuaian_bidang') }}
                                </div>
                            @endif
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\TracerStakeholder::KOMPETENSI_INTEGRITAS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="kompetensi_integritas_{{ $key }}" name="kompetensi_integritas" value="{{ $key }}" {{ old('kompetensi_integritas', '') === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\TracerStakeholder::KOMPETENSI_PROFESIONALISME_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="kompetensi_profesionalisme_{{ $key }}" name="kompetensi_profesionalisme" value="{{ $key }}" {{ old('kompetensi_profesionalisme', '') === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\TracerStakeholder::KOMPETENSI_INGGRIS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="kompetensi_inggris_{{ $key }}" name="kompetensi_inggris" value="{{ $key }}" {{ old('kompetensi_inggris', '') === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\TracerStakeholder::KOMPETENSI_IT_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="kompetensi_it_{{ $key }}" name="kompetensi_it" value="{{ $key }}" {{ old('kompetensi_it', '') === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\TracerStakeholder::KOMPETENSI_KOMUNIKASI_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="kompetensi_komunikasi_{{ $key }}" name="kompetensi_komunikasi" value="{{ $key }}" {{ old('kompetensi_komunikasi', '') === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\TracerStakeholder::KOMPETENSI_KERJASAMA_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="kompetensi_kerjasama_{{ $key }}" name="kompetensi_kerjasama" value="{{ $key }}" {{ old('kompetensi_kerjasama', '') === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\TracerStakeholder::KOMPETENSI_PENGEMBANGAN_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="kompetensi_pengembangan_{{ $key }}" name="kompetensi_pengembangan" value="{{ $key }}" {{ old('kompetensi_pengembangan', '') === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="kepuasan_alumni" id="kepuasan_alumni">{{ old('kepuasan_alumni') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="saran" id="saran">{{ old('saran') }}</textarea>
                            @if($errors->has('saran'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('saran') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\TracerStakeholder::KETERSEDIAAN_CAMPUS_HIRING_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="ketersediaan_campus_hiring_{{ $key }}" name="ketersediaan_campus_hiring" value="{{ $key }}" {{ old('ketersediaan_campus_hiring', '') === (string) $key ? 'checked' : '' }}>
