    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.test-magangs.update", [$testMagang->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="result" id="result" value="{{ old('result', $testMagang->result) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="q_1" id="q_1" value="{{ old('q_1', $testMagang->q_1) }}" step="1">
                            @if($errors->has('q_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('q_1') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="q_2" id="q_2" value="{{ old('q_2', $testMagang->q_2) }}">
                            @if($errors->has('q_2'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('q_2') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="q_3" id="q_3" value="{{ old('q_3', $testMagang->q_3) }}" step="1">
                            @if($errors->has('q_3'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('q_3') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="q_4" id="q_4" value="{{ old('q_4', $testMagang->q_4) }}" step="1">
                            @if($errors->has('q_4'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('q_4') }}
                                </div>
