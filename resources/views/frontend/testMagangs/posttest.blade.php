...
@section('title', 'Post-Test Magang - CDC Fakultas Psikologi UNS')

@section('breadcumb')
<div class="container">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Post-Test Magang</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Post-Test Magang</li>
            </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
</div><!-- /.container-fluid -->
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="posttestForm" method="POST" action="{{ route('frontend.mahasiswa-magangs.store-test') }}">
                        @csrf
                        ...
                        <div class="step active">
                            <div class="form-group">
                                <h5>Selamat Datang di Post-Test Magang</h5>
                                <p>
                                    Post-test ini dirancang untuk mengukur perkembangan kemampuan adaptasi dan pemecahan masalah Anda setelah menyelesaikan program magang. Jawablah semua pertanyaan dengan jujur sesuai dengan kondisi Anda saat ini. Tidak ada jawaban benar atau salah.
                                </p>
                                <p>
