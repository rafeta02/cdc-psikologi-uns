                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.companies.update", [$company->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $company->description) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="telephone" id="telephone" value="{{ old('telephone', $company->telephone) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="number_of_employee" id="number_of_employee" value="{{ old('number_of_employee', $company->number_of_employee) }}" step="1">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="featured" id="featured" value="1" {{ $company->featured || old('featured', 0) === 1 ? 'checked' : '' }}>
