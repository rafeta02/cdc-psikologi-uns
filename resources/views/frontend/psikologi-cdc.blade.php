...
@section('title', 'Profil CDC Fakultas Psikologi UNS - Career Development Center Fakultas Psikologi UNS')
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="text-center text-white">
                        <h3 class="mb-4">Profil CDC Fakultas Psikologi UNS</h3>
                        <div class="page-next">
                            <nav class="d-inline-block" aria-label="breadcrumb text-center">
                                <ol class="breadcrumb justify-content-center">
                                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"> Profil CDC Fakultas Psikologi UNS </li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="row align-items-center g-0">
                <div class="col-lg-10">
                    <div class="section-title me-lg-5">
                        <h6 class="sub-title">Profil CDC Fakultas Psikologi UNS</h6>
                ...
                <div class="col-lg-2">
                    <div class="about-img mt-4 mt-lg-0">
                        <img src="{{ asset('img/MeetTheTeam.png') }}" alt="" class="img-fluid rounded" style="width: 280px; height: auto; object-fit: cover;">
                    </div>
                </div><!--end col-->
            </div><!--end row-->
        </div><!--end container-->
