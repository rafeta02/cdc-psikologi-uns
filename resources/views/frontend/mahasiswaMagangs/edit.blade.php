    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.mahasiswa-magangs.update", [$mahasiswaMagang->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nim" id="nim" value="{{ old('nim', $mahasiswaMagang->nim) }}">
                            @if($errors->has('nim'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('nim') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nama" id="nama" value="{{ old('nama', $mahasiswaMagang->nama) }}">
                            @if($errors->has('nama'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('nama') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="semester" id="semester" value="{{ old('semester', $mahasiswaMagang->semester) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="instansi" id="instansi" value="{{ old('instansi', $mahasiswaMagang->instansi) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="alamat_instansi" id="alamat_instansi">{{ old('alamat_instansi', $mahasiswaMagang->alamat_instansi) }}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="pretest" id="pretest" value="1" {{ $mahasiswaMagang->pretest || old('pretest', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="posttest" id="posttest" value="1" {{ $mahasiswaMagang->posttest || old('posttest', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="dosen_pembimbing" id="dosen_pembimbing" value="{{ old('dosen_pembimbing', $mahasiswaMagang->dosen_pembimbing) }}">
