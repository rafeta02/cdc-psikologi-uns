                    ...
                    <form method="POST" action="{{ route("frontend.prestasi-mahasiswas.update", [$prestasiMahasiswa->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\PrestasiMahasiswa::SKIM_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="skim_{{ $key }}" name="skim" value="{{ $key }}" {{ old('skim', $prestasiMahasiswa->skim) === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\PrestasiMahasiswa::TINGKAT_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="tingkat_{{ $key }}" name="tingkat" value="{{ $key }}" {{ old('tingkat', $prestasiMahasiswa->tingkat) === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nama_kegiatan" id="nama_kegiatan" value="{{ old('nama_kegiatan', $prestasiMahasiswa->nama_kegiatan) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="tanggal_awal" id="tanggal_awal" value="{{ old('tanggal_awal', $prestasiMahasiswa->tanggal_awal) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="tanggal_akhir" id="tanggal_akhir" value="{{ old('tanggal_akhir', $prestasiMahasiswa->tanggal_akhir) }}">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\PrestasiMahasiswa::JUMLAH_PESERTA_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="jumlah_peserta_{{ $key }}" name="jumlah_peserta" value="{{ $key }}" {{ old('jumlah_peserta', $prestasiMahasiswa->jumlah_peserta) === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nama_penyelenggara" id="nama_penyelenggara" value="{{ old('nama_penyelenggara', $prestasiMahasiswa->nama_penyelenggara) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tempat_penyelenggara" id="tempat_penyelenggara" value="{{ old('tempat_penyelenggara', $prestasiMahasiswa->tempat_penyelenggara) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="no_wa" id="no_wa" value="{{ old('no_wa', $prestasiMahasiswa->no_wa) }}" required>
                            @if($errors->has('no_wa'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('no_wa') }}
                                </div>
