    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.work-readiness-tests.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cbs_1" id="cbs_1" value="{{ old('cbs_1', '1') }}" step="1">
                            @if($errors->has('cbs_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cbs_1') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cbs_2" id="cbs_2" value="{{ old('cbs_2', '1') }}" step="1">
                            @if($errors->has('cbs_2'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cbs_2') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cbs_3" id="cbs_3" value="{{ old('cbs_3', '1') }}" step="1">
                            @if($errors->has('cbs_3'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cbs_3') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cbs_4" id="cbs_4" value="{{ old('cbs_4', '1') }}" step="1">
                            @if($errors->has('cbs_4'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cbs_4') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cbs_5" id="cbs_5" value="{{ old('cbs_5', '1') }}" step="1">
                            @if($errors->has('cbs_5'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cbs_5') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cbs_6" id="cbs_6" value="{{ old('cbs_6', '1') }}" step="1">
                            @if($errors->has('cbs_6'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cbs_6') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cbs_7" id="cbs_7" value="{{ old('cbs_7', '1') }}" step="1">
                            @if($errors->has('cbs_7'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cbs_7') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cbs_8" id="cbs_8" value="{{ old('cbs_8', '1') }}" step="1">
                            @if($errors->has('cbs_8'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cbs_8') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cbs_9" id="cbs_9" value="{{ old('cbs_9', '1') }}" step="1">
                            @if($errors->has('cbs_9'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cbs_9') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cbs_10" id="cbs_10" value="{{ old('cbs_10', '1') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cms_1" id="cms_1" value="{{ old('cms_1', '1') }}" step="1">
                            @if($errors->has('cms_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cms_1') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cms_2" id="cms_2" value="{{ old('cms_2', '1') }}" step="1">
                            @if($errors->has('cms_2'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cms_2') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cms_3" id="cms_3" value="{{ old('cms_3', '1') }}" step="1">
                            @if($errors->has('cms_3'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cms_3') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cms_4" id="cms_4" value="{{ old('cms_4', '1') }}" step="1">
                            @if($errors->has('cms_4'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cms_4') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cs_1" id="cs_1" value="{{ old('cs_1', '1') }}" step="1">
                            @if($errors->has('cs_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cs_1') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cs_2" id="cs_2" value="{{ old('cs_2', '1') }}" step="1">
                            @if($errors->has('cs_2'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cs_2') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cs_3" id="cs_3" value="{{ old('cs_3', '1') }}" step="1">
                            @if($errors->has('cs_3'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cs_3') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cs_4" id="cs_4" value="{{ old('cs_4', '1') }}" step="1">
                            @if($errors->has('cs_4'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cs_4') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cs_5" id="cs_5" value="{{ old('cs_5', '1') }}" step="1">
                            @if($errors->has('cs_5'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cs_5') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cs_6" id="cs_6" value="{{ old('cs_6', '1') }}" step="1">
                            @if($errors->has('cs_6'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cs_6') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cs_7" id="cs_7" value="{{ old('cs_7', '1') }}" step="1">
                            @if($errors->has('cs_7'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cs_7') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cs_8" id="cs_8" value="{{ old('cs_8', '1') }}" step="1">
                            @if($errors->has('cs_8'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cs_8') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cs_9" id="cs_9" value="{{ old('cs_9', '1') }}" step="1">
                            @if($errors->has('cs_9'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cs_9') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fs_1" id="fs_1" value="{{ old('fs_1', '1') }}" step="1">
                            @if($errors->has('fs_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('fs_1') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fs_2" id="fs_2" value="{{ old('fs_2', '1') }}" step="1">
                            @if($errors->has('fs_2'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('fs_2') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fs_3" id="fs_3" value="{{ old('fs_3', '1') }}" step="1">
                            @if($errors->has('fs_3'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('fs_3') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="ics_1" id="ics_1" value="{{ old('ics_1', '1') }}" step="1">
                            @if($errors->has('ics_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ics_1') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="ics_2" id="ics_2" value="{{ old('ics_2', '1') }}" step="1">
                            @if($errors->has('ics_2'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ics_2') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="ics_3" id="ics_3" value="{{ old('ics_3', '1') }}" step="1">
                            @if($errors->has('ics_3'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ics_3') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="ics_4" id="ics_4" value="{{ old('ics_4', '1') }}" step="1">
                            @if($errors->has('ics_4'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ics_4') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="ics_5" id="ics_5" value="{{ old('ics_5', '1') }}" step="1">
                            @if($errors->has('ics_5'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ics_5') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="its_1" id="its_1" value="{{ old('its_1', '1') }}" step="1">
                            @if($errors->has('its_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('its_1') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="its_2" id="its_2" value="{{ old('its_2', '1') }}" step="1">
                            @if($errors->has('its_2'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('its_2') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="its_3" id="its_3" value="{{ old('its_3', '1') }}" step="1">
                            @if($errors->has('its_3'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('its_3') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="ls_1" id="ls_1" value="{{ old('ls_1', '1') }}" step="1">
                            @if($errors->has('ls_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ls_1') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="ls_2" id="ls_2" value="{{ old('ls_2', '1') }}" step="1">
                            @if($errors->has('ls_2'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ls_2') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="ls_3" id="ls_3" value="{{ old('ls_3', '1') }}" step="1">
                            @if($errors->has('ls_3'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ls_3') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="ls_4" id="ls_4" value="{{ old('ls_4', '1') }}" step="1">
                            @if($errors->has('ls_4'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ls_4') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="ls_5" id="ls_5" value="{{ old('ls_5', '1') }}" step="1">
                            @if($errors->has('ls_5'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ls_5') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sms_1" id="sms_1" value="{{ old('sms_1', '1') }}" step="1">
                            @if($errors->has('sms_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sms_1') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sms_3" id="sms_3" value="{{ old('sms_3', '1') }}" step="1">
                            @if($errors->has('sms_3'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sms_3') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sms_4" id="sms_4" value="{{ old('sms_4', '1') }}" step="1">
                            @if($errors->has('sms_4'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sms_4') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sms_5" id="sms_5" value="{{ old('sms_5', '1') }}" step="1">
                            @if($errors->has('sms_5'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sms_5') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sms_7" id="sms_7" value="{{ old('sms_7', '1') }}" step="1">
                            @if($errors->has('sms_7'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sms_7') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sms_9" id="sms_9" value="{{ old('sms_9', '1') }}" step="1">
                            @if($errors->has('sms_9'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sms_9') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sts_1" id="sts_1" value="{{ old('sts_1', '1') }}" step="1">
                            @if($errors->has('sts_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sts_1') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sts_2" id="sts_2" value="{{ old('sts_2', '1') }}" step="1">
                            @if($errors->has('sts_2'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sts_2') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sts_3" id="sts_3" value="{{ old('sts_3', '1') }}" step="1">
                            @if($errors->has('sts_3'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sts_3') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sts_4" id="sts_4" value="{{ old('sts_4', '1') }}" step="1">
                            @if($errors->has('sts_4'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sts_4') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="tps_2" id="tps_2" value="{{ old('tps_2', '1') }}" step="1">
                            @if($errors->has('tps_2'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('tps_2') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="tps_4" id="tps_4" value="{{ old('tps_4', '1') }}" step="1">
                            @if($errors->has('tps_4'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('tps_4') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="tps_5" id="tps_5" value="{{ old('tps_5', '1') }}" step="1">
                            @if($errors->has('tps_5'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('tps_5') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="tps_6" id="tps_6" value="{{ old('tps_6', '1') }}" step="1">
                            @if($errors->has('tps_6'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('tps_6') }}
                                </div>
