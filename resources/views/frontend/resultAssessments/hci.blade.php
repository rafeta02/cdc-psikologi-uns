...
@section('title', 'Assesment Minat Pekerjaan - CDC Fakultas Psikologi UNS')

@section('breadcumb')
<div class="container">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0"> Assesment Minat Pekerjaan</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Assesment Minat Pekerjaan</li>
            </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
</div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    Asessment {{ App\Models\ResultAssessment::TEST_NAME_SELECT['hci'] }}
                </div>
                                ...
                                @foreach ($questionPair as $question)
                                    <div class="card mb-3">
                                        ...
                                        <div class="custom-radio-group">
                                            ...
                                            <input type="radio" id="id_{{ $question->code }}_0" name="{{ $question->code }}" value="0">
                                            <label for="id_{{ $question->code }}_0"></label>
