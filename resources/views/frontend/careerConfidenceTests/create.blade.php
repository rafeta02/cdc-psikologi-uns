    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.career-confidence-tests.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="r_1" id="r_1" value="{{ old('r_1', '1') }}" step="1">
                            @if($errors->has('r_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('r_1') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="r_2" id="r_2" value="{{ old('r_2', '1') }}" step="1">
                            @if($errors->has('r_2'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('r_2') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="r_3" id="r_3" value="{{ old('r_3', '1') }}" step="1">
                            @if($errors->has('r_3'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('r_3') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="r_4" id="r_4" value="{{ old('r_4', '1') }}" step="1">
                            @if($errors->has('r_4'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('r_4') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="i_1" id="i_1" value="{{ old('i_1', '1') }}" step="1">
                            @if($errors->has('i_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('i_1') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="i_2" id="i_2" value="{{ old('i_2', '1') }}" step="1">
                            @if($errors->has('i_2'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('i_2') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="i_3" id="i_3" value="{{ old('i_3', '1') }}" step="1">
                            @if($errors->has('i_3'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('i_3') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="i_4" id="i_4" value="{{ old('i_4', '1') }}" step="1">
                            @if($errors->has('i_4'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('i_4') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="a_1" id="a_1" value="{{ old('a_1', '1') }}" step="1">
                            @if($errors->has('a_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('a_1') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="a_2" id="a_2" value="{{ old('a_2', '1') }}" step="1">
                            @if($errors->has('a_2'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('a_2') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="a_3" id="a_3" value="{{ old('a_3', '1') }}" step="1">
                            @if($errors->has('a_3'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('a_3') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="a_4" id="a_4" value="{{ old('a_4', '1') }}" step="1">
                            @if($errors->has('a_4'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('a_4') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="s_1" id="s_1" value="{{ old('s_1', '1') }}" step="1">
                            @if($errors->has('s_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('s_1') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="s_2" id="s_2" value="{{ old('s_2', '1') }}" step="1">
                            @if($errors->has('s_2'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('s_2') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="s_3" id="s_3" value="{{ old('s_3', '1') }}" step="1">
                            @if($errors->has('s_3'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('s_3') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="s_4" id="s_4" value="{{ old('s_4', '1') }}" step="1">
                            @if($errors->has('s_4'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('s_4') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="e_1" id="e_1" value="{{ old('e_1', '1') }}" step="1">
                            @if($errors->has('e_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('e_1') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="e_2" id="e_2" value="{{ old('e_2', '1') }}" step="1">
                            @if($errors->has('e_2'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('e_2') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="e_3" id="e_3" value="{{ old('e_3', '1') }}" step="1">
                            @if($errors->has('e_3'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('e_3') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="e_4" id="e_4" value="{{ old('e_4', '1') }}" step="1">
                            @if($errors->has('e_4'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('e_4') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="c_1" id="c_1" value="{{ old('c_1', '1') }}" step="1">
                            @if($errors->has('c_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('c_1') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="c_2" id="c_2" value="{{ old('c_2', '1') }}" step="1">
                            @if($errors->has('c_2'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('c_2') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="c_3" id="c_3" value="{{ old('c_3', '1') }}" step="1">
                            @if($errors->has('c_3'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('c_3') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="c_4" id="c_4" value="{{ old('c_4', '1') }}" step="1">
                            @if($errors->has('c_4'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('c_4') }}
                                </div>
