    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.vacancies.update", [$vacancy->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.vacancy.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $vacancy->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $vacancy->description) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="open_date" id="open_date" value="{{ old('open_date', $vacancy->open_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="close_date" id="close_date" value="{{ old('close_date', $vacancy->close_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="persyaratan_umum" id="persyaratan_umum">{!! old('persyaratan_umum', $vacancy->persyaratan_umum) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="persyaratan_khusus" id="persyaratan_khusus">{!! old('persyaratan_khusus', $vacancy->persyaratan_khusus) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="registration" id="registration">{!! old('registration', $vacancy->registration) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="job_description" id="job_description">{!! old('job_description', $vacancy->job_description) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="minimum_gpa" id="minimum_gpa" value="{{ old('minimum_gpa', $vacancy->minimum_gpa) }}" step="0.01" max="4">
