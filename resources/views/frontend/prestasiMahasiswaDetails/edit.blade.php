    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.prestasi-mahasiswa-details.update", [$prestasiMahasiswaDetail->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="nim">{{ trans('cruds.prestasiMahasiswaDetail.fields.nim') }}</label>
                            <input class="form-control" type="text" name="nim" id="nim" value="{{ old('nim', $prestasiMahasiswaDetail->nim) }}" required>
                            @if($errors->has('nim'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nama" id="nama" value="{{ old('nama', $prestasiMahasiswaDetail->nama) }}" required>
                            @if($errors->has('nama'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('nama') }}
                                </div>
