    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.monitoring-magangs.update", [$monitoringMagang->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="tanggal" id="tanggal" value="{{ old('tanggal', $monitoringMagang->tanggal) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tempat" id="tempat" value="{{ old('tempat', $monitoringMagang->tempat) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="hasil" id="hasil">{!! old('hasil', $monitoringMagang->hasil) !!}</textarea>
                            @if($errors->has('hasil'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('hasil') }}
                                </div>
