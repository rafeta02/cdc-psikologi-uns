            ...
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="text-center mb-5">
                        <p class="text-danger fw-semibold mb-0">Fashion</p>
                    ...
                    <div class="blog-post">
                        <div class="swiper blogdetailSlider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="{{ asset('jobcy/images/blog/img-11.jpg') }}" alt="" class="img-fluid rounded-3">
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('jobcy/images/blog/img-14.jpg') }}" alt="" class="img-fluid rounded-3">
                                </div>
                                <div class="swiper-slide">
                                    <img src="{{ asset('jobcy/images/blog/img-15.jpg') }}" alt="" class="img-fluid rounded-3">
                                </div>
                            </div>
                        </div>
                            ...
                            <li class="list-inline-item">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('jobcy/images/blog/img-03.jpg') }}" alt="" class="avatar-sm rounded-circle">
                                    </div>
                                    <div class="ms-3">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="d-flex align-items-center mb-4">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <a href="javascript:void(0)" class="badge bg-success-subtle text-success mt-1 fs-14">Business</a>
                                    <a href="javascript:void(0)" class="badge bg-success-subtle text-success mt-1 fs-14">design</a>
                                    <a href="javascript:void(0)" class="badge bg-success-subtle text-success mt-1 fs-14">Creative</a>
                                    <a href="javascript:void(0)" class="badge bg-success-subtle text-success mt-1 fs-14">Event</a>
                                </div>
                            </div>
                        ...
                        <div class="mt-5">
                            <div class="d-sm-flex align-items-top">
                                <div class="flex-shrink-0">
                                    <img class="rounded-circle avatar-md img-thumbnail" src="{{ asset('jobcy/images/blog/img-01.jpg') }}" alt="img" />
                                </div>
                        ...
                        <div class="mt-5">
                            <div class="d-sm-flex align-items-top">
                                <div class="flex-shrink-0">
                                    <img class="rounded-circle avatar-md img-thumbnail" src="{{ asset('jobcy/images/blog/img-02.jpg') }}" alt="img" />
                                </div>
                                <div class="flex-grow-1 ms-sm-3">
                                    ...
                                    <div class="d-sm-flex align-items-top mt-5">
                                        <div class="flex-shrink-0">
                                            <img class="rounded-circle avatar-md img-thumbnail" src="{{ asset('jobcy/images/blog/img-04.jpg') }}" alt="img" />
                                        </div>
                                        <div class="flex-grow-1 ms-sm-3">
                                            <small class="float-end fs-12 text-muted"><i class="uil uil-clock"></i> 2 hrs Ago</small>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="card blog-modern-box overflow-hidden border-0">
                                            <img src="{{ asset('jobcy/images/blog/img-11.jpg') }}" alt="" class="img-fluid">
                        ...
                        <div class="mt-4 pt-2">
                            ...
                            <div class="my-3">
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" value="" id="education" readonly/>
                                    <label class="form-check-label ms-2" for="education">Education</label>
                                </div>
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked1" readonly checked />
                                    <label class="form-check-label ms-2" for="flexCheckChecked1">Business</label>
                                </div>
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked2" readonly checked />
                                    <label class="form-check-label ms-2" for="flexCheckChecked2">Information</label>
                                </div>
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked3" readonly />
                                    <label class="form-check-label ms-2" for="flexCheckChecked3">Interview</label>
                                </div>
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked4" readonly />
                        ...
                        <div class="mt-4 pt-2">
                            ...
                            <ul class="widget-popular-post list-unstyled my-4">
                                <li class="d-flex mb-3 align-items-center pb-3 border-bottom">
                                    <img src="{{ asset('jobcy/images/blog/img-11.jpg') }}" alt="" class="widget-popular-post-img rounded" />
