    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.prestasi-mabas.update", [$prestasiMaba->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            ...
                            @foreach(App\Models\PrestasiMaba::TINGKAT_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="tingkat_{{ $key }}" name="tingkat" value="{{ $key }}" {{ old('tingkat', $prestasiMaba->tingkat) === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nama_kegiatan" id="nama_kegiatan" value="{{ old('nama_kegiatan', $prestasiMaba->nama_kegiatan) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="tanggal_awal" id="tanggal_awal" value="{{ old('tanggal_awal', $prestasiMaba->tanggal_awal) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="tanggal_akhir" id="tanggal_akhir" value="{{ old('tanggal_akhir', $prestasiMaba->tanggal_akhir) }}">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\PrestasiMaba::JUMLAH_PESERTA_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="jumlah_peserta_{{ $key }}" name="jumlah_peserta" value="{{ $key }}" {{ old('jumlah_peserta', $prestasiMaba->jumlah_peserta) === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nama_penyelenggara" id="nama_penyelenggara" value="{{ old('nama_penyelenggara', $prestasiMaba->nama_penyelenggara) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tempat_penyelenggara" id="tempat_penyelenggara" value="{{ old('tempat_penyelenggara', $prestasiMaba->tempat_penyelenggara) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\PrestasiMaba::KEIKUTSERTAAN_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="keikutsertaan_{{ $key }}" name="keikutsertaan" value="{{ $key }}" {{ old('keikutsertaan', $prestasiMaba->keikutsertaan) === (string) $key ? 'checked' : '' }}>
