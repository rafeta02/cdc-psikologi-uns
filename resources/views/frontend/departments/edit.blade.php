                    ...
                    <form method="POST" action="{{ route("frontend.departments.update", [$department->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="featured" id="featured" value="1" {{ $department->featured || old('featured', 0) === 1 ? 'checked' : '' }}>
                                <label for="featured">{{ trans('cruds.department.fields.featured') }}</label>
                            </div>
