...
class HomeController
{
    ...
    {
        $settings1 = [
            'chart_title'           => 'Total Lowongan',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Vacancy',
            'group_by_field'        => 'open_date',
            'group_by_period'       => 'day',
        ...
        $settings7 = [
            'chart_title'           => 'Tracer Alumni',
            'chart_type'            => 'bar',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\TracerAlumnu',
            'group_by_field'        => 'created_at',
